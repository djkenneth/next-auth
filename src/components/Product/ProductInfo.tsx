...
const ProductInfo = ({ productName, productPrice, productIsAvailable, productComparePrice }) => {
  ...
  return (
    <>
      <Heading
        className="text-2xl text-slate-800 font-sans font-semibold tracking-wide"
      ...
      <div className="flex justify-items-center mb-2">
        ...
        <Text className="text-sm text-gray-600" customContainerStyle="flex items-center mr-2">
          28 reviews
        </Text>
        |
        <Text className="text-sm text-gray-600" customContainerStyle="flex items-center ml-2 cursor-pointer hover:underline hover:underline-offset-2 hover:decoration-gray-600">
      ...
      <div className="flex justify-between mb-5">
        ...
        <div>
          <Text className="text-sm text-gray-400 m-1">Availability: {productIsAvailable > 0 ? 'In Stock' : 'Out of Stock'}</Text>
        </div>
      </div>
